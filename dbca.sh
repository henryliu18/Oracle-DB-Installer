...
if [ "$O_VER" = "18c" ]; then
  bash `dirname $0`/18c/dbca.sh
elif [ "$O_VER" = "12c" ]; then
  bash `dirname $0`/12c/dbca.sh
elif [ "$O_VER" = "11.2" ]; then
  bash `dirname $0`/11.2/dbca.sh
elif [ "$O_VER" = "10.2" ]; then
  bash `dirname $0`/10.2/dbca.sh
elif [ "$O_VER" = "9.2" ]; then
  bash `dirname $0`/9.2/dbca.sh
elif [ "$O_VER" = "8.1.7" ]; then
  bash `dirname $0`/8.1.7/dbca.sh
fi
